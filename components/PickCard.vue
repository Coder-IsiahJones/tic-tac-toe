...
<template>
  ...
  >
    ...
    <!-- Remember -->
    <p class="text-center text-light-gray-blue text-sm">
...
<style scoped>
.selected {
  @apply bg-light-gray-blue w-full h-14 rounded-[8px];
}
</style>
