...
<template>
  <div class="h-dvh bg-dark-blue py-32 px-6 flex flex-col gap-8 items-center">
    <svg
    ...
    <!-- New Game (VS CPU)-->
    <button
      class="rounded-2xl bg-orange pt-4 pb-6 w-full text-base font-bold"
      style="box-shadow: 0px -8px 0px 0px #cc8b13 inset"
      @click="startGame()"
    >
      NEW GAME (VS CPU)
    </button>
    ...
    <!-- New Game (VS Player) -->
    <button
      class="rounded-2xl bg-blue-cyan pt-4 pb-6 w-full text-base font-bold"
      style="box-shadow: 0px -8px 0px 0px #118c87 inset"
      @click="startGame()"
    >
      NEW GAME (VS PLAYER)
    </button>
